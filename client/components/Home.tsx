...
export default function Home() {
  ...
  return (
    ...
    <div  style={{ fontFamily: 'Lato, sans-serif' }}>
      {/* Top bar */}
<nav className="bg-gray-700 text-white flex justify-between items-center p-4 flex-col sm:flex-row">
  ...
  <h1 className="text-md font-semibold m-0 text-center sm:text-right sm:ml-4">
    Give us a call today!
  </h1>
  <h1 className="text-md font-semibold m-0 text-center sm:text-right sm:mr-4">
    (022) 106 6710
  </h1>
</nav>

{/* Main Navbar */}
<nav className="bg-white-600 text-black p-8 flex justify-between items-center h-24 sm:px-12 sm:flex-row flex-col sm:h-auto" style={{ fontFamily: 'Playfair Display, serif' }}>
  <img src="https://res.cloudinary.com/dynrnpszg/image/upload/v1747100454/geroslogo4_zb5lwt.png" alt="Logo" className="h-20 w-auto rounded-md mb-4 sm:mb-0" />

  <div className="space-x-6 flex flex-wrap sm:space-x-6 sm:flex-nowrap items-center justify-center sm:justify-between">
