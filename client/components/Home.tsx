...
export default function Home() {
 ...
 />
      ...
      <div className="additional-info" style={{ padding: '20px', textAlign: 'center' }}>
        ...
        <p
          data-aos="fade-up"
          className="mx-4 md:mx-52 mt-4 text-gray-700 max-w-4xl mx-auto"
      ...
      {/* Smaller Card Layout */}
      <div className="flex justify-center flex-wrap gap-10 mt-6 px-4 md:px-0">
        <div data-aos="fade-up" className="w-full sm:w-[300px] text-center border rounded-lg shadow-lg p-4">
